...
*Last polled for new developments: March 30, 2026, 7:24 PM ET.*
...
- **TeamPCP continuing attacks**: No new package compromises in 96+ hours as of March 30 (longest quiet period since campaign began March 19). SANS ISC Update 004 confirmed zero TeamPCP IOCs in RubyGems, crates.io, or Maven Central. The group has fully shifted to monetization/extortion of existing access via dual CipherForce/Vect ransomware operations. CipherForce has no confirmed deployments yet. Additional supply chain compromises remain possible. [source: https://isc.sans.edu/forums/diary/32846/]
...
- **No clean LiteLLM release**: PyPI still shows v1.82.6 as latest as of March 30 (8 days since last clean release). GitHub releases at v1.82.6.dev2. BerriAI has paused all releases pending Mandiant review. CISA KEV deadline is April 9, now 9 days away.

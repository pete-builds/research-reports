...
date: 2026-03-24
updated: 2026-03-25T22:30:00-04:00
...
- **Law enforcement/government response**: DanielRuf confirmed he notified both CISA and German CERT (CERT-Bund/BSI). FBI Assistant Director Brett Leatherman has issued a public warning but no formal advisory or investigation announcement. Microsoft published detection guidance. NHS England Digital published cyber alert CC-4761. CVE-2026-33634 is still not in the CISA KEV catalog. No CISA advisory published yet. GitHub has banned/blocked the 123 compromised accounts used for spam.
- **Threat intel platform gap partially closing**: As of 10:30 PM ET March 25, MalwareBazaar now has three hash entries (SHA-256, MD5, SHA-1) tagged `checkmarx-zone,models-litellm-cloud` (first seen 8:07 AM ET March 25). However, the six network IoCs (models.litellm.cloud, 46.151.182.203, checkmarx.zone, 83.142.209.11, scan.aquasecurtiy.org, 45.148.10.212) still return zero hits across URLhaus, ThreatFox, Feodo Tracker, and AlienVault OTX. OTX pulse searches for "TeamPCP," "litellm," and "supply chain" still return zero results. Coverage improving but domain/IP indicators remain uncataloged.
- **CVE assignment**: PYSEC-2026-2 has been assigned (PyPI-specific advisory). The upstream Trivy compromise received **CVE-2026-33634** (CVSS:3.1 AV:N/AC:L/PR:L/UI:N/S:C/C:H/I:H/A:H, CWE-506: Embedded Malicious Code, assigned by GitHub's CNA; GitHub advisory GHSA-69fq-xp46-6x23) [source: https://github.com/aquasecurity/trivy/discussions/10425, https://nvd.nist.gov/vuln/detail/CVE-2026-33634]. Snyk also issued **SNYK-PYTHON-LITELLM-15762713** for the LiteLLM compromise. No LiteLLM-specific CVE (CVE-2026-XXXXX) on NVD yet as of March 25. CVE-2026-33634 is NOT in the CISA KEV catalog. Security researcher DanielRuf has proposed escalating to CISA for an industry-wide warning. No standalone CISA advisory published as of this update.
...
- **No new clean version published**: Latest on PyPI is still 1.82.6; latest GitHub release is v1.82.3-stable.patch.2 (published March 24). As of 10:30 PM ET March 25, BerriAI is still reviewing codebase security before releasing a clean version. [source: https://github.com/BerriAI/litellm/issues/24518]
- **Threat intel gap persists**: As of 10:30 PM ET March 25, all six network IoCs (models.litellm.cloud, 46.151.182.203, checkmarx.zone, 83.142.209.11, scan.aquasecurtiy.org, 45.148.10.212) still return zero hits across URLhaus, ThreatFox, Feodo Tracker, and AlienVault OTX. MalwareBazaar has three hash entries but domain/IP indicators remain uncataloged. No OTX pulses for "TeamPCP" or "litellm" exist yet.

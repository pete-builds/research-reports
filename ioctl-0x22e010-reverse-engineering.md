...
**Time-sensitive observations (as of April 15, 2026):**
...
- Ten PoisonX variants [cataloged on LOLDrivers](https://www.loldrivers.io/drivers/fc3467c3-6109-447d-b438-7a4276c3d8e5/) as of April 10, 2026. LOLDrivers count confirmed unchanged as of April 15 check.
- **ESET ecosystem report (March 2026)** tracks nearly **90 EDR killers** in active use, including **54 BYOVD-based tools** abusing **35 vulnerable drivers**, plus 7 script-based tools and 15 anti-rootkit/utility tools. Rentdrv2/PoisonX is one driver among this 35-driver ecosystem. ([GBHackers summary](https://gbhackers.com/edr-killers/), [VPNCentral summary](https://vpncentral.com/ransomware-gangs-now-use-more-edr-killers-that-do-not-rely-on-vulnerable-drivers-eset-says/))
- **"EDR killer as a service"** is now a commercial offering on underground markets. Tools like DemoKiller, AbyssKiller, and CardSpaceKiller are sold to affiliates of Qilin, Medusa, and Akira ransomware groups. ([CyberPress](https://cyberpress.org/ransomware-groups-increasingly-turn-to-edr-killers/))
- **Driverless EDR killers emerging**: EDRSilencer and EDR-Freeze block EDR network communications or freeze EDR processes without kernel access, bypassing driver-focused defenses entirely. ([CyberPress](https://cyberpress.org/ransomware-groups-increasingly-turn-to-edr-killers/))
- **DragonForce** (which uses Rentdrv2 as a BYOVD backend) accounted for approximately **8% of 672 ransomware incidents** in March 2026, alongside Qilin and Akira (combined 40% of all attacks). Check Point attributed the surge partly to absorption of displaced RansomHub affiliates. ([Infosecurity Magazine, April 10, 2026](https://www.infosecurity-magazine.com/news/three-ransomware-gangs-40-percent/))
...
- **(April 2026 update)** ESET's March 2026 ecosystem report places Rentdrv2/PoisonX within a much larger landscape of ~90 EDR killers. The BYOVD technique is now a routine stage in ransomware operations, not a novel tactic. Three distribution models exist: in-house development by closed ransomware groups (Embargo, DeadLock, Warlock), modification of public PoC code (including [BlackSnufkin/BYOVD](https://github.com/BlackSnufkin/BYOVD) repos), and commercial "EDR killer as a service" sold on underground markets. ([GBHackers](https://gbhackers.com/edr-killers/), [CyberPress](https://cyberpress.org/ransomware-groups-increasingly-turn-to-edr-killers/))
- **(April 2026 update)** Driverless EDR killers (EDRSilencer, EDR-Freeze) represent the next evolution: they block EDR network communications or freeze agent processes without loading any kernel driver, sidestepping HVCI, WDAC, and driver blocklist controls entirely. Organizations relying solely on driver-level defenses should also monitor for anomalous network-blocking behavior and unexpected EDR agent communication failures. ([CyberPress](https://cyberpress.org/ransomware-groups-increasingly-turn-to-edr-killers/))
...
| ESET ecosystem: ~90 EDR killers, 54 BYOVD, 35 drivers | **High** | Consistent across multiple independent summaries (GBHackers, VPNCentral, CyberPress) of the same ESET source report |
| DragonForce 8% of March 2026 incidents | **High** | Sourced from Infosecurity Magazine citing Check Point data |
| Driverless EDR killers (EDRSilencer, EDR-Freeze) | **Medium** | Named in multiple summaries of ESET research; specific technical details not independently verified beyond the summaries |
...
### EDR Killer Ecosystem (added April 15, 2026)

- ESET. EDR killer ecosystem research, March 2026. Cited via: [GBHackers](https://gbhackers.com/edr-killers/), [VPNCentral](https://vpncentral.com/ransomware-gangs-now-use-more-edr-killers-that-do-not-rely-on-vulnerable-drivers-eset-says/), [CyberPress](https://cyberpress.org/ransomware-groups-increasingly-turn-to-edr-killers/).
- Dark Reading. ["EDR-Killer Ecosystem Expansion Requires Stronger BYOVD Defenses."](https://www.darkreading.com/vulnerabilities-threats/edr-killer-ecosystem-expansion-requires-stronger-byovd-defenses) April 14, 2026. (403 at fetch time; content sourced from syndicated copies.)
- Infosecurity Magazine. ["Just Three Ransomware Gangs Accounted for 40% of Attacks Last Month."](https://www.infosecurity-magazine.com/news/three-ransomware-gangs-40-percent/) April 10, 2026.
...
| Date | Summary |
|------|---------|
| 2026-04-15 22:24 ET | Added ESET ecosystem context (~90 EDR killers, 54 BYOVD tools, 35 drivers). Added driverless EDR killer evolution (EDRSilencer, EDR-Freeze). Added "EDR killer as a service" market data. Updated DragonForce activity (8% of March 2026 incidents). Confirmed LOLDrivers PoisonX count unchanged at 10. No new IOCs or CVE changes found. |
| 2026-04-14 | Initial report published. |
